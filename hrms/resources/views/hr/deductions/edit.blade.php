<x-layout>
    ...
    <div class="max-w-xl mx-auto p-6 bg-gray-50 rounded shadow-lg mt-8">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Payroll Deduction Settings</h2>
            <a href="{{ route('hr.show-payroll') }}" class="text-teal-600 hover:underline text-sm">← Back to Payroll</a>
        </div>
        ...
        <form method="POST" action="{{ route('hr.update-payroll-deductions') }}">
            ...
            <button type="submit" class="cursor-pointer hover:bg-teal-500 bg-teal-600 text-white px-4 py-2 rounded">Update Settings</button>
        </form>
    </div>
